  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        played_after: { type: 'string', description: 'ISO date-time with timezone: only return events on/after this instant' },
        played_before: { type: 'string', description: 'ISO date-time with timezone: only return events on/before this instant' },
